...
import { AdminLogo as AdminLogo_admin_logo_icon, AdminIcon as AdminIcon_admin_logo_icon } from "../../../components/admin/admin-logo-icon";
...
export const importMap = {
  ...
  "/components/admin/admin-logo-icon#AdminIcon": AdminIcon_admin_logo_icon,
};
