...
function buildLlmsTxt(): string {
  const lines = [
    ...
    "",
    `${siteConfig.name} is not a general-purpose chatbot builder for open-ended conversation, and it is not a headless LLM API — it is scoped to answering from content you provide it.`,
    "",
    "## Product",
    "",
